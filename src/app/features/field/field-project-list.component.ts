...
const FINDING_KIND_LABEL: Record<string, string> = {
  ...
  DOOBLO_SURVEY_INTERVIEW_IDS_UPSTREAM: 'Calidad respuesta: error al listar entrevistas',
  DOOBLO_OPERATIONDATA_UPSTREAM: 'Calidad respuesta: error al leer datos de operación',
  DOOBLO_RESPONSE_QUALITY_NO_TABULAR_ROWS: 'Calidad respuesta: sin tabla JSON reconocible',
  DOOBLO_RESPONSE_QUALITY_EMPTY_SAMPLE: 'Muestra tabular vacía (sin sujetos)',
  DOOBLO_GPS_NO_COORDINATES_IN_TABULAR: 'GPS: sin coordenadas reconocibles en export',
