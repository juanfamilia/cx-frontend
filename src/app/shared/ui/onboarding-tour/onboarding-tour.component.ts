  ...
  template: `
    @if (isVisible && currentStep) {
      <div class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <!-- Tour Card -->
        <div class="relative z-10 w-full max-w-md mx-4 bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden">
          <!-- Header -->
            ...
            <div class="mt-6 flex items-center gap-1">
              @for (step of steps; track $index) {
                <div 
                  ...
                  [class.bg-blue-600]="$index <= currentStepIndex"
                  [class.bg-gray-300]="$index > currentStepIndex"
                  [class.dark:bg-gray-600]="$index > currentStepIndex">
                </div>
              }
            </div>
          </div>
